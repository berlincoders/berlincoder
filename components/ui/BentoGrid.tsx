      ...
      {id === 1 ? (
        <>
          ...
          <div
            className={cn(
              titleClassName,
              "group-hover/bento:translate-x-2 transition duration-200 relative px-5 py-5 lg:py-10"
            )}
          >
            <div className="font-sans text-lg lg:text-3xl font-bold mb-2">
              {title}
            </div>
            <div className="font-sans font-extralight text-sm md:text-xs lg:text-base text-[#C1C2D3]">
              {description}
            </div>
          </div>
        </>
        ...
        <div className={`${id === 6 && 'flex justify-center'} h-full`}>
          ...
          {id === 5 ? (
            <div
              className={cn(
                titleClassName,
                'relative flex flex-col px-5 lg:px-10 pt-6 gap-2 z-10'
              )}
            >
